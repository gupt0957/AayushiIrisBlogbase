...
<html lang="eng">
      ...
      <nav class="flex-div">
          ...
          if(isset($_SESSION["username"])){
            ...
            <div class="nav-right flex-div">
                ...
                <a href="bussiness.php"><img src="editor_img.png"></a>
            <?php
          }else{
            ?>
      <div class="nav-right flex-div">
    ...
    ?>
      ...
      <?php
       try {
         $stmt = $con->query("SELECT postID, postTitle, postDesc, postDate,post_type FROM blog_posts WHERE is_approved=1 and post_type= 'Travel' ORDER BY postID DESC");
