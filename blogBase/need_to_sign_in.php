...
<html lang="eng">
    ...
    <body>
        <div class="container" style = "background-color: #f8f8fe;">
           ...
           <div class ="row1" style ="height:600px">
                ...
                <center>
                    ...
                    <br>
                    <a class ="maincontent" href="index.php">Return Home</a>
                    <br>
                    <br>
                    <h3><a class ="maincontent" href="login.php">Log In</a></h3>
                    <br>
                    <h3><a class ="maincontent" href="register.php">Sign Up</a></h3>
                </center>
            </div> 
